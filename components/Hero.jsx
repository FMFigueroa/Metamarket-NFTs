const style = {
    ...
    ctaContainer: `flex my-[2.5rem] justify-center`,
    accentedButton: ` relative text-lg font-semibold px-12 py-3 bg-[#0070f3] rounded-lg mr-5 text-white hover:bg-[#42a0ff] cursor-pointer`,
                ...
                <div className={style.contentWrapper}>
                    <div className={style.copyContainer}>
                        <div className={style.title}>
                            Discover, collect, and sell extraordinary NFTs in 3D
                        </div>
                        <div className={style.description}>
                            Metamarket 3D is the world&apos;s first and largest NFT  marketplace
                        </div>
